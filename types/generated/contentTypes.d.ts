...
export interface ApiStateMapStateMap extends Struct.CollectionTypeSchema {
  collectionName: 'state_maps';
  info: {
    displayName: 'StateMap';
    pluralName: 'state-maps';
    singularName: 'state-map';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    canonical_state: Schema.Attribute.Enumeration<
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::state-map.state-map'
    > &
      Schema.Attribute.Private;
    progress_weight: Schema.Attribute.Decimal;
    project_type: Schema.Attribute.Enumeration<
      ['values', 'culture', 'feedback360']
    >;
    publishedAt: Schema.Attribute.DateTime;
    raw_status: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    assignee_role: Schema.Attribute.Enumeration<['dev', 'lead', 'facilitator']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    estimate_hours: Schema.Attribute.Integer & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::task.task'> &
      Schema.Attribute.Private;
    project_type: Schema.Attribute.Enumeration<
      ['Values', 'Feedback360', 'Culture']
    >;
    publishedAt: Schema.Attribute.DateTime;
    task_class: Schema.Attribute.Enumeration<['delivery', 'admin', 'review']>;
    task_id: Schema.Attribute.UID;
    task_name: Schema.Attribute.Text;
    task_status: Schema.Attribute.Enumeration<
      ['planned', 'in_progress', 'qa', 'done']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
